...
Version 1.15 - 19-Aug-2013    Fixed one Strict: error message

*/
$Version = "nws-alerts.php - 1.15 - 19-Aug-2013 - NWS Public Alerts"; 
...
';
  ...
  if($useAlertBox and !empty($atData)) {                                                       // IF use alert box & have data
	...
	$abta = array_keys($soryByALert);
    $abta = array_shift($abta);                                              // get first alert (key) severity code
