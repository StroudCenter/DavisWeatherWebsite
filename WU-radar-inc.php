...
$RDR  = 'DOX';  // last 3 characters of NOAA Radar Site Name
$Lat  = '39.860359';    //North=positive, South=negative decimal degrees
$Long = '-75.781230';  //East=positive, West=negative decimal degrees
$City = 'Avondale';  // Name of city
$WUregion = 'ne';    // WeatherUnderground regional map group name
...
$WUname2	= 'Chester County';	// tooltip label for mode=2
$WUname3	= 'Southeast PA';	// tooltip label for mode=3
$WUname4	= 'Northeast US';	// tooltip label for mode=4
...
$CityPos1  =  'left: 395px; top: -268px;';
$CityColor1 = '#FFFFFF';  // color of legend display
// see instructions above to set  $CityURL value
$CityURL = 'http://radblast.wunderground.com/cgi-bin/radar/WUNIDS_map?station=DOX&brand=wui&num=1&delay=15&type=N0R&frame=0&scale=0.125&noclutter=0&showstorms=0&mapx=400&mapy=240&centerx=632&centery=1120&transx=232&transy=880&showlabels=1&severe=0&rainsnow=0&lightning=0&smooth=0&rand=23373834&lat=39.82267761&lon=-75.77639771&label=';

// $CityPos2 - for Metro Level radar/animation	 
$CityPos2  =  'left: 427px; top: -224px;';
$CityColor2 = '#FFFFFF';  // color of legend display
// see instructions above to set  $MetroURL value
$MetroURL = 'http://radblast.wunderground.com/cgi-bin/radar/WUNIDS_map?station=DOX&brand=wui&num=1&delay=15&type=N0R&frame=0&scale=0.20217391304347826&noclutter=0&showstorms=0&mapx=400&mapy=240&centerx=575.5913978494623&centery=821.1827956989247&transx=175.59139784946228&transy=581.1827956989247&showlabels=1&severe=0&rainsnow=0&lightning=0&smooth=0&rand=23373845&lat=39.860359&lon=-75.781230&label=';


// $CityPos3 - for unzoomed radar/animation
$CityPos3  =  'left: 368px; top: -364px;';
$CityColor3 = '#FFFFFF';  // color of legend display

// $CityPos4 - for US Advisory map
$CityPos4  =  'left: 547px; top: -343px;';
$CityColor4 = '#FFFFFF';  // color of legend display

// $CityPos5 = USA Radar/animation	 
$CityPos5  =  'left: 322px; top: -224px;';
$CityColor5 = '#FFFFFF';  // color of legend display

// $CityPos6 - for USA Radar Map
$CityPos6  =  'left: 551px; top: -338px;';
$CityColor6 = '#FFFFFF';  // color of legend display

// $CityPos7 - Regional maps (Fronts, Satellite, Wind, Jet Stream, Snow Depth, etc)
$CityPos7  =  'left: 321px; top: -220px;';
$CityColor7 = '#FFFFFF';  // color of legend display

// $CityPos8 - for USA Flu map
$CityPos8  =  'left: 546px; top: -338px;';
$CityColor8 = '#0000FF';  // color of legend display

// $CityPos9 - for Regional Advisories map
$CityPos9  =  'left: 323px; top: -184px;';
