...
$SITE['organ']			= 'Weather from Davis Vantage Pro 2 at the Stroud Water Research Center Weather';
$SITE['copyr']			= '&copy; ' . date("Y",time()) . ', Stroud Water Research Center';
$SITE['location']       = 'Avondale, PA, USA';
$SITE['email']			= 'mailto:shicks@stroudcenter.org';
# Station location: latitude, longitude, cityname
$SITE['latitude']		= '39.860359';    //North=positive, South=negative decimal degrees
$SITE['longitude']		= '-75.781230';  //East=positive, West=negative decimal degrees
$SITE['cityname']		= 'Avondale';
...
$SITE['fcsturlNWS']		= 'http://forecast.weather.gov/MapClick.php?CityName=Saratoga&state=PA&site=MTR&textField1=39.860359&textField2=-75.781230&e=1&TextType=2';
...
// use "Zone|Location|Point-printableURL",  as entries .. first one will be the default forecast.
  "PAZ101|Avondale|http://forecast.weather.gov/MapClick.php?CityName=Avondale&state=PA&site=MTR&textField1=39.83&textField2=-75.79&e=1&TextType=2",
);
...
// NOAA warning zone
$SITE['noaazone'] 		= 'PAZ101'; // used for NOAA advisories and advforecast2.php zone forecasts
...
$SITE['NWSalertsCodes'] = array(
  "Eastern Chester County|PA102|PAC029",
//  "Santa Cruz Mtns|CAZ512|CAC081|CAC085|CAC087",
  "Western Chester County|PA101|PAC029",
...
// Radar settings
$SITE['noaaradar']		= 'DOX';   		// LAST 3 characters of NOAA Radar Site ID
										// e.g. Radar KMUX has $SITE['noaaradar'] = 'MUX';
$SITE['WUregion']	= 'ne';				// Wunderground regional maps
...
$SITE['GR3radar']	= 'kdox';	// set to lower-case full name of NEXRAD radar site
